...
@Component({
  ...
  template: `
    <!-- BEGIN: ImpactSection -->
    <section class="relative py-16 sm:py-20 bg-[#F8FAF7] overflow-hidden border-t border-[#E2E8F0]" id="impacto">
      <!-- Watermarked volcano silhouette background -->
      <div class="absolute inset-0 opacity-5 pointer-events-none flex items-end justify-center" aria-hidden="true">
      ...
      <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-12">
          ...
          <div class="group hover-lift bg-white rounded-2xl p-6 sm:p-7 shadow-xs hover:shadow-lg border border-[#E2E8F0] hover:border-[#22a652] flex flex-col justify-between reveal-init transition-all"
               [class.reveal-active]="isVisible"
               style="transition-delay: 50ms">
            <div>
              <div class="w-12 h-12 rounded-2xl bg-[#ecf7e6] text-[#22a652] flex items-center justify-center text-lg shadow-xs group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300 ease-out mb-4">
                <i class="fa-solid fa-scale-balanced"></i>
              </div>
              <p class="text-3xl sm:text-4xl lg:text-5xl font-black text-[#123F5B] font-heading tracking-tight mb-1 whitespace-nowrap">
            ...
            <p class="text-xs text-slate-500 mt-2 leading-relaxed border-t border-[#E2E8F0] pt-2.5">
          ...
          <div class="group hover-lift bg-white rounded-2xl p-6 sm:p-7 shadow-xs hover:shadow-lg border border-[#E2E8F0] hover:border-[#22a652] flex flex-col justify-between reveal-init transition-all"
            ...
            <div>
              ...
              <p class="text-3xl sm:text-4xl lg:text-5xl font-black text-[#123F5B] font-heading tracking-tight mb-1 whitespace-nowrap">
                {{ currentPercent }}<span class="text-2xl sm:text-3xl font-bold text-[#22a652]">%</span>
              </p>
              <h3 class="text-sm sm:text-base font-bold text-slate-800 leading-snug group-hover:text-[#22a652] transition-colors duration-200">
          ...
          <div class="group hover-lift bg-white rounded-2xl p-6 sm:p-7 shadow-xs hover:shadow-lg border border-[#E2E8F0] hover:border-[#22a652] flex flex-col justify-between reveal-init transition-all"
            ...
            <div>
              ...
              <p class="text-3xl sm:text-4xl lg:text-5xl font-black text-[#123F5B] font-heading tracking-tight mb-1 whitespace-nowrap">
                {{ currentTrucks }} <span class="text-lg sm:text-xl font-bold text-[#22a652]">camiones</span>
              </p>
              <h3 class="text-sm sm:text-base font-bold text-slate-800 leading-snug group-hover:text-[#22a652] transition-colors duration-200">
        ...
        <div class="group relative rounded-2xl overflow-hidden shadow-lg hover:shadow-xl border border-slate-200/90 min-h-[200px] sm:min-h-[230px] flex items-center reveal-init"
          ...
          <div class="relative z-10 p-6 sm:p-10 w-full flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div class="flex items-start gap-4 max-w-xl">
              <div class="shrink-0 w-12 h-12 rounded-2xl bg-[#ecf7e6] border border-[#22a652]/30 flex items-center justify-center text-[#22a652] text-xl mt-1 shadow-xs group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300 ease-out">
                <i class="fa-solid fa-truck-ramp-box"></i>
              </div>
              <div>
                <h3 class="text-xl sm:text-2xl lg:text-3xl font-black text-[#123F5B] tracking-tight mb-1.5 font-heading">
            ...
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 shrink-0">
              <a
                ...
                class="btn-interactive group/btn inline-flex items-center justify-center gap-2.5 bg-[#22a652] hover:bg-[#1b8e45] text-white text-xs sm:text-sm font-bold py-3.5 px-6 rounded-xl shadow-md hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#22a652] focus-visible:ring-offset-2 cursor-pointer text-center">
